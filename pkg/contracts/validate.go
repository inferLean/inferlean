...
func validateWorkloadObservations(w WorkloadObservations) []error {
	...
	errs = append(errs, validateEnum("workload_observations.declared_workload_target", w.DeclaredWorkloadTarget, "extreme_latency", "latency", "throughput", "extreme_throughput", "unknown"))
